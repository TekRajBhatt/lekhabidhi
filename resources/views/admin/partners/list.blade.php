            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('partner.index') }}" type="button" class="btn btn-tool">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="btn-group col-lg-1">
                            <a href="{{ route('partner.index') }}" class="btn btn-primary btn-flat btn-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="card-tools float-right">
                                @can('partner-create')
                                    <a href="{{ route('partner.create') }}" class="btn btn-success btn-sm btn-flat mr-2">
                                        <i class="fa fa-plus"></i>Add New Partner</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @can('partner-edit')
                                                <a href="{{ route('partner.edit', $value->id) }}" title="Edit partner"
                                                    class="btn btn-success btn-sm btn-flat"><i class="fas fa-edit"></i></a>
                                            @endcan
                                            @can('partner-delete')
                                                {{ Form::open(['method' => 'DELETE', 'route' => ['partner.destroy', $value->id], 'style' => 'display:inline', 'onsubmit' => 'return confirm("Are you sure you want to delete this partner?")']) }}
                                                {{ Form::button('<i class="fas fa-trash-alt"></i>', ['class' => 'btn btn-danger btn-sm btn-flat', 'type' => 'submit', 'title' => 'Delete partner ']) }}
                                                {{ Form::close() }}
                                            @endcan
                                        </div>
                                    </td>
