...
<script src="{{ asset('/custom/partner.js') }}"></script>
    <script>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (isset($client_info))
                        {{ Form::open(['url' => route('partner.update', $client_info->id), 'files' => true, 'class' => 'form', 'name' => 'partner_form']) }}
                        @method('put')
                    @else
                        {{ Form::open(['url' => route('partner.store'), 'files' => true, 'class' => 'form', 'name' => 'partner_form']) }}
                    @endif
                    <div class="row">
                        <div class="col-lg-8">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group row {{ $errors->has('logo') ? 'has-error' : '' }}">
                                {{ Form::label('logo', 'Image:*', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-9">
