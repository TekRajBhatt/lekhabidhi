...
@section('title', $title)
    ...
    <script src="/vendor/laravel-filemanager/js/stand-alone-button.js"></script>
        ...
        <script src="{{ asset('/custom/step.js') }}"></script>
        <script>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('step.index') }}" type="button" class="btn btn-tool">
                ...
                <div class="card-body">
                    @if (isset($step_info))
                        {{ Form::open(['url' => route('step.update', $step_info->id), 'files' => true, 'class' => 'form', 'name' => 'step_form']) }}
                        @method('put')
                    @else
                        {{ Form::open(['url' => route('step.store'), 'files' => true, 'class' => 'form', 'name' => 'step_form']) }}
                    @endif
                    <div class="row">
                        <div class="col-lg-8 ">
                            ...
                            <div class="form-group row {{ $errors->has('title') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::text('title', @$step_info->title, ['class' => 'form-control', 'id' => 'title', 'placeholder' => 'Title', 'required' => true, 'style' => 'width:80%']) }}
                                    @error('title')
                            ...
                            <div class="form-group row {{ $errors->has('description') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::textarea('description', @$step_info->description, ['class' => 'form-control ckeditor', 'id' => 'my-editor', 'placeholder' => 'Description', 'required' => true, 'style' => 'width:80%']) }}
                                    @error('description')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group row {{ $errors->has('position') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::number('position', @$step_info->position, ['class' => 'form-control', 'id' => 'position', 'placeholder' => 'Position', 'required' => true, 'style' => 'width:80%']) }}
                                    @error('description')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('image') ? 'has-error' : '' }}">
                                {{ Form::label('image', 'Icon :*', ['class' => 'col-sm-3']) }}
                                <div class="col-sm-9">
                                    {{ Form::text('image', @$step_info->image, ['class' => 'form-control', 'id' => 'image', 'placeholder' => 'Icon Name', 'required' => true, 'style' => 'width:80%']) }}
                                    @error('image')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
...
<!--
                            <div class="form-group row {{ $errors->has('image') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div id="holder" style="border-radius: 4px;
                                                      ...
                                                      width: 150px;
                                                      margin-top:15px;"></div>
                                    @if (isset($step_info->image))
                                        Old Image: &nbsp; <img src="{{ $step_info->image }}" alt="Couldn't load image"
                            ...
                            <div class="form-group row {{ $errors->has('display_home') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('display_home', [1 => 'Yes', 0 => 'No'], @$step_info->display_home, ['id' => 'display_home', 'required' => true, 'class' => 'form-control', 'style' => 'width:80%']) }}
                                    @error('display_home')
                                        <span class="help-block error">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row {{ $errors->has('publish_status') ? 'has-error' : '' }}">
                                ...
                                <div class="col-sm-9">
                                    {{ Form::select('publish_status', [1 => 'Yes', 0 => 'No'], @$step_info->publish_status, ['id' => 'publish_status', 'required' => true, 'class' => 'form-control', 'style' => 'width:80%']) }}
