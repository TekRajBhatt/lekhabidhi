                ...
                <div class="card-header">
                    <div class="row">
                        <div class="btn-group col-lg-1">
                            <a href="{{ route('business.index') }}" class="btn btn-primary btn-flat btn-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="card-tools float-right">
                                @can('business-create')
                                <a href="{{ route('business.create') }}" class="btn btn-success btn-sm btn-flat mr-2">
                            ...
                            @foreach ($data as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            @can('business-edit')
                                                <a href="{{ route('business.edit', $value->id) }}" title="Edit business"
...
<script>
    $(function() {
      $('.publish_status').change(function() {
          ...
          $.ajax({
              type: "POST",
              url: "{{route('business.changeStatus')}}",
              data: data,
