        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Trending Software List</h3>
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="btn-group col-lg-1">
                            <a href="{{ route('information.index') }}" class="btn btn-primary btn-flat btn-sm">
                                <i class="fas fa-sync-alt fa-sm"></i> Refresh
                            </a>
                        </div>
                        <div class="col-lg-7">
                            <form action="{{route('information.index')}}" class="" method="get">
                                <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card-tools float-right">
                                ...
                                <a href="{{ route('information.create') }}" class="btn btn-success btn-sm btn-flat mr-2">
                                    <i class="fa fa-plus"></i> Add New Trending Software</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                            ...
                            <td>{{@$value->view_count}}</td>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <a href="{{route('information.edit',$value->id)}}" title="Edit Information" class="btn btn-success btn-sm btn-flat"><i class="fas fa-edit"></i></a>
                                  @endcan
                                  @can('information-delete')
                                  {{Form::open(['method' => 'DELETE','route' => ['information.destroy', $value->id],'style'=>'display:inline','onsubmit'=>'return confirm("Are you sure you want to delete this Information?")']) }}
                                  {{Form::button('<i class="fas fa-trash-alt"></i>',['class'=>'btn btn-danger btn-sm btn-flat','type'=>'submit','title'=>'Delete Information '])}}
                                  {{ Form::close() }}
                                  @endcan
                              </div>
                              </td>
