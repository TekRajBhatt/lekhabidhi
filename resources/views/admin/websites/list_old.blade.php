                        ...
                        <div class="col-lg-4">
                            <div class="card-tools float-right">
                                ...
                                <a href="{{ route('website.create') }}" class="btn btn-success btn-sm btn-flat mr-2">
                                    <i class="fa fa-plus"></i> Add New Website Content</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>Phone Number</th>
                                <th>Address</th>
                                <th>Testimonial First Image</th>
                                {{-- <th>Testimonial Second Image</th> --}}
                                <th>Display Home</th>
                                <th>Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>{!! $value->address !!}</td>
                              {{-- <td>{!! $value->first_img !!}</td> --}}
                              {{-- <td>
                                  <img src="{{ $value->first_img }}" alt="" class="img img-thumbail" style="width:60px">
                              </td>

                              <td>{!! $value->second_img !!}</td> --}}
