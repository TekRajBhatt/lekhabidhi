...
class InformationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $request->session()->flash('success', 'Trending Software created successfully.');
    ...
    public function edit(Request $request, $id)
    {
        ...
        $title = 'Update Trending Software';
        return view('admin/informations/form', compact('information_info', 'title'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $request->session()->flash('success', 'Trending Software updated successfully.');
            return redirect()->route('information.index');
        } catch (\Exception $error) {
            $request->session()->flash('error', $error->getMessage());
            return redirect()->back();
    ...
    public function destroy(Request $request, $id)
    {
        ...
        try {
            ...
            $request->session()->flash('success', 'Trending Software deleted successfully.');
            return redirect()->route('information.index');
        } catch (\Exception $error) {
            $request->session()->flash('error', $error->getMessage());
            return redirect()->back();
